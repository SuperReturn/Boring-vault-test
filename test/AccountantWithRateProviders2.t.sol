...
contract AccountantWithRateProviders2Test is Test, MerkleTreeHelper {
    ...
    function testMassiveYieldEarned() external {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(AccountantWithRateProviders2.AccountantWithFixedRate__UnsafeUint96Cast.selector)
        );
    ...
    function testReverts() external {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(AccountantWithRateProviders2.AccountantWithFixedRate__HighWaterMarkCannotChange.selector)
        );
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                AccountantWithRateProviders2.AccountantWithFixedRate__StartingExchangeRateCannotBeGreaterThanFixed.selector
            )
        );
        new AccountantWithRateProviders2(
            address(this),
            address(boringVault),
            payout_address,
            1.01e18,
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                AccountantWithRateProviders2.AccountantWithFixedRate__OnlyCallableByYieldDistributor.selector
            )
        );
        accountant.claimYield(WETH);

        // It should revert if claimYield is called when no yield is owed.
        vm.expectRevert(abi.encodeWithSelector(AccountantWithRateProviders2.AccountantWithFixedRate__ZeroYieldOwed.selector));
