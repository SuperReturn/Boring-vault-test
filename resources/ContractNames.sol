...
contract ContractNames {
    ...
    string public constant UsdaiVaultQueueSolverName = "SuperUSD Vault Queue Solver V0.4";
    ...
    string public constant UsdaiMorphoDecoderAndSanitizerName = "SuperUSD Morpho Decoder and Sanitizer V0.0";
    string public constant UsdaiOpenEdenDecoderAndSanitizerName = "SuperUSD OpenEden Decoder and Sanitizer V0.0";
    string public constant UsdaiKyoDecoderAndSanitizerName = "SuperUSD Kyo Decoder and Sanitizer V0.0";
    string public constant UsdaiBaseDecoderAndSanitizerName = "SuperUSD Base Decoder and Sanitizer V0.0";
    string public constant UsdaiRoosterDecoderAndSanitizerName = "SuperUSD Rooster Decoder and Sanitizer V0.0";
    string public constant UsdaiEulerDecoderAndSanitizerName = "SuperUSD Euler Decoder and Sanitizer V0.0";
    string public constant UsdaiMerklDecoderAndSanitizerName = "SuperUSD Merkl Decoder and Sanitizer V0.0";

    // sUSDAI 
    string public constant sUsdaiBoringOnChainQueuesRolesAuthorityName = "sSuperUSD Boring OnChain Queues Roles Authority V0.0";
    string public constant sUsdaiVaultRolesAuthorityName = "sSuperUSD Vault RolesAuthority V0.0";
    string public constant sUsdaiArcticArchitectureLensName = "sSuperUSD Arctic Architecture Lens V0.0";
    ...
    string public constant sUsdaiVaultQueueSolverName = "sSuperUSD Vault Queue Solver V0.3";
