...
import {TellerWithMultiAssetSupportV2, ERC20} from "src/base/Roles/TellerWithMultiAssetSupportV2.sol";
import {MessageLib} from "src/base/Roles/CrossChain/MessageLib.sol";

abstract contract CrossChainTellerWithGenericBridge is TellerWithMultiAssetSupportV2 {
    ...
    constructor(address _owner, address _vault, address _accountant, address _weth)
        TellerWithMultiAssetSupportV2(_owner, _vault, _accountant, _weth)
    {}
