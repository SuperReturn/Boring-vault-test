 ...
 */
contract UpgradesSuperUSDScript is Script, KatanaBokutoAddresses, ContractNames, MerkleTreeHelper {
    // Contract instances
    ...
    function run() public {
        ...
        if(newImplementation != 0xee4f83E83b699E91960FA237cC3188B71cc5713F) {
            console.log("Incorrect sSuperUSD vault implementation address. Expected", 0xee4f83E83b699E91960FA237cC3188B71cc5713F, "got", newImplementation);
