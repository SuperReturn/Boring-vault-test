...
/**
 *  source .env && forge script script/DeployKatSuperUSD.s.sol:DeployDeployKatSuperUSDScript --with-gas-price 70000000 --evm-version london --broadcast --etherscan-api-key $KATANA_BOKUTO_SCAN_KEY --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployDeployKatSuperUSDScript is Script, ContractNames, KatanaBokutoAddresses {
