...
contract DeployOneInchDecoderAndSanitizerScript is Script, ContractNames, ArbitrumAddresses, MerkleTreeHelper {
    ...
    function run() external {
        ...
        deployer.deployContract(UsdaiOneInchDecoderAndSanitizerName, creationCode, constructorArgs, 0);
