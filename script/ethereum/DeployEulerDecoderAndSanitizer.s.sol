...
contract DeployEulerDecoderAndSanitizerScript is Script, ContractNames, EthereumAddresses, MerkleTreeHelper {
    ...
    function run() external {
        ...
        creationCode = type(EulerDecoderAndSanitizer).creationCode;
        constructorArgs = abi.encode(
            previoussuperUSD
        );
        deployer.deployContract(UsdaiEulerDecoderAndSanitizerName, creationCode, constructorArgs, 0);
