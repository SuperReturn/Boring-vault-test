...
contract BaseOp is Script, EthereumAddresses, MerkleTreeHelper, ContractNames {
    ...
    function run() public {
        ...
        setAddress(true, mainnet, "boringVault", previoussSuperUSD);
        ...
        _addApprovalLeafs(leafs, ERC20(getAddress(sourceChain, "USDC")), vm.addr(strategist));
        ...
        targetData[1] = abi.encodeWithSignature("transfer(address,uint256)", 0x62d9113BFf4414e7D3600FfB4d6255D29e5CFc42, 19999e6);
        ...
        _generateLeafs("./leafs/EthereumBaseLeafs.json", leafs, merkleRoot, manageTree);
