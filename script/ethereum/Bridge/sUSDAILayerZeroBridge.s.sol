 ...
 * @notice This script demonstrates how to deposit USDC and ASTR into the sUSDAI vault on Mainnet
 * @dev Run with: forge script script/USDAIIntegrationTest/Deposit.sol --rpc-url $MINATO_RPC_URL
 */
contract SUSDAILayerZeroBridgeScript is Script, EthereumAddresses, ContractNames, MerkleTreeHelper {
