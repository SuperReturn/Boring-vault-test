...
contract DeployMerklDecoderAndSanitizerScript is Script, ContractNames, EthereumAddresses, MerkleTreeHelper {
    ...
    function run() external {
        ...
        deployer.deployContract(UsdaiMerklDecoderAndSanitizerName, creationCode, constructorArgs, 0);
