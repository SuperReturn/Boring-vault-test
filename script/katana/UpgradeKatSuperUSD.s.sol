...
/**
 *  source .env && forge script script/UpgradeKatSuperUSD.s.sol:UpgradeKatSuperUSDScript --with-gas-price 70000000 --evm-version london --broadcast --etherscan-api-key $KATANA__SCAN_KEY --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract UpgradeKatSuperUSDScript is Script, ContractNames, KatanaAddresses {
